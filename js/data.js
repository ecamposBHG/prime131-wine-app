...
const DISHES = [
  ...
  { id: "d-chefs-nigiri", name: "Chef's Selection of Nigiri", section: "Sushi", description: "Chef's choice, 3/6/9/12 pieces", pairedWineIds: ["w10", "w20"], dropLine: "chefs choice of nigiri selection", ingredients: "seasoned sushi rice, fresh grated wasabi, seasonal garnishes", chefPrep: "chefs choice of 5,7 and 10 pcs of freshest daily nigiri selection served with, fres grated wasabi.", allergensInRecipe: ["fish", "shellfish", "vinegar"], allergensRemovable: ["shellfish"] },
  { id: "d-sashimi-platter", name: "Premium Sashimi Platter", section: "Sushi", description: "Chef's choice variations", pairedWineIds: ["w20"], dropLine: "sashimi platter with traditional garnishes", ingredients: "fish might include in the platter- maguro (yellowfin tuna, akami (lean bluefin tuna), chutoro (medium fatty bluefin tuna), otoro (fattiest part of bluefin tuna) scottish salmon, fresh oysters with ponzu,  ikura (marinated salmon eggs), madai (red sea bream), continued on omasake platter discription", chefPrep: "chefs choice of 5,9 and 12 kinds of freshest daily sashimi selection served with, daikon, shiso leaves and other garnished over crushed ice and light underneath. Served 2 pc fish per kind.", allergensInRecipe: ["egg", "fish", "gluten", "shellfish", "soy"], allergensRemovable: ["egg", "gluten", "shellfish", "soy"] },
  { id: "d-omakase-platter", name: "Prime 131 Omakase Platter", section: "Sushi", description: "14 pcs sashimi, 14 pcs nigiri, choice of 3 specialty rolls", pairedWineIds: ["w20"], dropLine: "Prime 131 premium omakase platter", ingredients: "shima aji (stripped jack), uni (sea urchin roe), botan ebi (peony sweet shrimp), hotate (scallop), ebi (tiger prawn),  tobiko (flying fish roe), tamago (egg), uzura (quail egg), hamachi (yellowtail), unagi (fresh water eel)", chefPrep: "chef’s selection of highest end 14 pcs sashimi, 14 pcs nigiri, 3 specialty rolls (guests choice)", allergensInRecipe: ["egg", "gluten", "sesame", "shellfish", "soy", "vinegar"], allergensRemovable: ["egg", "gluten", "sesame", "shellfish", "soy"] },
