...
// Staff dictionary: not textbook definitions -- what it means, why it matters on the floor,
// and (only when genuinely guest-facing) a line you could actually say.
const DICTIONARY = [
  // Wine & Tasting
  { id: "dict-tannin", term: "Tannin", category: "Wine & Tasting",
    whatItMeans: "The drying, gripping sensation from grape skins, seeds, and oak -- most noticeable in red wine.",
    whyItMatters: "It's what makes a big red wine pair well with fat (steak) and clash with spicy food.",
    sayItLikeThis: "This wine has real grip -- it wants a fatty cut like the ribeye." },
  { id: "dict-acidity", term: "Acidity", category: "Wine & Tasting",
    whatItMeans: "The tartness or brightness in a wine, felt as mouthwatering on the sides of your tongue.",
    whyItMatters: "High-acid wines cut through rich or fried food and pair naturally with citrus-forward dishes.",
    sayItLikeThis: "This has bright acidity -- it'll cut right through the richness of that dish." },
  { id: "dict-malolactic", term: "Malolactic Fermentation (\u201cmalo\u201d)", category: "Wine & Tasting",
    whatItMeans: "A secondary fermentation that converts sharp malic acid (green apple) into softer lactic acid (milk) -- done by bacteria, not yeast.",
    whyItMatters: "It's what makes a Chardonnay taste buttery and round instead of crisp and tart. It's a winemaking choice, not a grape trait.",
    sayItLikeThis: "That creamy texture isn't oak -- it's a process called malolactic fermentation." },
  { id: "dict-terroir", term: "Terroir", category: "Wine & Tasting",
    whatItMeans: "The combination of soil, climate, and location that gives a wine its specific character -- literally \u201ca sense of place.\u201d",
    whyItMatters: "It's why two Chardonnays from different regions can taste completely different despite being the same grape.",
    sayItLikeThis: "" },
  { id: "dict-vintage", term: "Vintage", category: "Wine & Tasting",
    whatItMeans: "The year the grapes were harvested, printed on the label.",
    whyItMatters: "Weather varies year to year, so vintage can meaningfully change a wine's character, especially for age-worthy bottles.",
    sayItLikeThis: "" },
  { id: "dict-decant", term: "Decant", category: "Wine & Tasting",
    whatItMeans: "Pouring wine into a separate vessel before serving, to let it breathe or to separate sediment from an older wine.",
    whyItMatters: "Young, tannic reds often taste smoother and more open after decanting; older wines are decanted to leave sediment behind.",
    sayItLikeThis: "Would you like this decanted? It'll open up the aromas a bit." },
  { id: "dict-corked", term: "Corked", category: "Wine & Tasting",
    whatItMeans: "A wine flaw caused by a contaminated cork (TCA), making the wine smell like wet cardboard or a musty basement.",
    whyItMatters: "It's a legitimate reason to send a bottle back -- not the same thing as a guest simply not liking the wine.",
    sayItLikeThis: "That bottle seems corked -- let me bring you a fresh one right away." },
  { id: "dict-legs", term: "Legs (or \u201ctears\u201d)", category: "Wine & Tasting",
    whatItMeans: "The streaks that run down the inside of a wine glass after swirling.",
    whyItMatters: "They're an indicator of alcohol and sugar content, not quality -- a common guest myth worth being ready to gently correct.",
    sayItLikeThis: "That's actually from the alcohol and a bit of sugar, not a sign of quality." },
  { id: "dict-nose-palate-finish", term: "Nose, Palate, Finish", category: "Wine & Tasting",
    whatItMeans: "The three stages of tasting: the aroma (nose), the flavor while it's in your mouth (palate), and what lingers after you swallow (finish).",
    whyItMatters: "It's the basic vocabulary for describing any wine to a guest in a structured way.",
    sayItLikeThis: "" },
  { id: "dict-reserve", term: "Reserve", category: "Wine & Tasting",
    whatItMeans: "A producer-specific term, not legally regulated in the US, usually signaling a higher-quality or specially-aged bottling.",
    whyItMatters: "It doesn't guarantee anything on its own -- it's a marketing term, not a certification, so don't oversell what it promises.",
    sayItLikeThis: "" },

  // Bar & Cocktails
  { id: "dict-neat", term: "Neat", category: "Bar & Cocktails",
    whatItMeans: "A spirit served with no ice and no mixer, straight from the bottle at room temperature.",
    whyItMatters: "Different from \u201cup,\u201d which is chilled with ice first, then strained.",
    sayItLikeThis: "Neat, or would you like that on the rocks?" },
  { id: "dict-up", term: "Up", category: "Bar & Cocktails",
    whatItMeans: "A drink shaken or stirred with ice, then strained into a glass with no ice.",
    whyItMatters: "One of the standard martini decision points, alongside dry/dirty and olive/twist.",
    sayItLikeThis: "Up or on the rocks?" },
  { id: "dict-dirty", term: "Dirty", category: "Bar & Cocktails",
    whatItMeans: "Olive brine added to a drink, shifting it from dry to salty and savory.",
    whyItMatters: "A guest saying \u201cdirty\u201d expects you to know instantly what changes in the build.",
    sayItLikeThis: "" },
  { id: "dict-muddle", term: "Muddle", category: "Bar & Cocktails",
    whatItMeans: "Gently pressing fruit, herbs, or sugar in the bottom of a glass to release their oils and juices before building a drink.",
    whyItMatters: "It's the technique behind a Mojito or Mint Julep. Over-muddling mint releases bitter chlorophyll, so it's a light touch, not a mash.",
    sayItLikeThis: "" },
  { id: "dict-express", term: "Express (a peel)", category: "Bar & Cocktails",
    whatItMeans: "Bending a piece of citrus peel over a drink to release its aromatic oils onto the surface.",
    whyItMatters: "It's an aroma technique, not just garnish -- it's why a Sazerac's lemon peel is expressed and then discarded, not left in the glass.",
    sayItLikeThis: "" },
  { id: "dict-float", term: "Float", category: "Bar & Cocktails",
    whatItMeans: "Pouring one ingredient, usually cream or a liqueur, gently over the back of a spoon so it sits on top instead of mixing in.",
    whyItMatters: "It's what creates a layered look, like a White Russian, and lets the guest choose whether to stir it in.",
    sayItLikeThis: "" },
  { id: "dict-jigger", term: "Jigger", category: "Bar & Cocktails",
    whatItMeans: "The small metal measuring tool bartenders use to pour exact amounts of spirits and liqueurs.",
    whyItMatters: "Consistency -- the same cocktail should taste the same every time, and that starts with accurate measuring, not free-pouring.",
    sayItLikeThis: "" },
  { id: "dict-rim", term: "Rim", category: "Bar & Cocktails",
    whatItMeans: "Coating the edge of a glass with salt, sugar, or spice before pouring the drink, like a Margarita's salt rim.",
    whyItMatters: "It's a guest preference worth confirming upfront, not assuming.",
    sayItLikeThis: "Would you like that salt-rimmed, or no rim?" },

  // Kitchen & Prep
  { id: "dict-sear", term: "Sear", category: "Kitchen & Prep",
    whatItMeans: "Cooking the surface of a protein at high heat to create a browned crust, without necessarily cooking it through.",
    whyItMatters: "It's about flavor and texture contrast, not doneness -- a seared piece of tuna can still be raw in the center.",
    sayItLikeThis: "" },
  { id: "dict-braise", term: "Braise", category: "Kitchen & Prep",
    whatItMeans: "Searing a tough cut of meat first, then slow-cooking it in liquid at low heat for a long time until tender.",
    whyItMatters: "It's why the short rib is fall-apart tender despite being a tougher cut -- time and moisture break down connective tissue.",
    sayItLikeThis: "" },
  { id: "dict-confit", term: "Confit", category: "Kitchen & Prep",
    whatItMeans: "Cooking something slowly and gently, submerged in fat, at low temperature.",
    whyItMatters: "It's a preservation and flavor technique, different from frying -- lower heat, longer time, no crisping.",
    sayItLikeThis: "" },
  { id: "dict-brine", term: "Brine", category: "Kitchen & Prep",
    whatItMeans: "Soaking something in a salt-water solution before cooking, to season it throughout and help it retain moisture.",
    whyItMatters: "It's why the Ebi stays juicy despite being fully cooked -- the brine does its work before the heat ever hits it.",
    sayItLikeThis: "" },
  { id: "dict-blanch", term: "Blanch", category: "Kitchen & Prep",
    whatItMeans: "Briefly boiling a vegetable, then immediately shocking it in ice water to stop the cooking.",
    whyItMatters: "It sets bright color and crisp texture without fully cooking through.",
    sayItLikeThis: "" },
  { id: "dict-reduction", term: "Reduction", category: "Kitchen & Prep",
    whatItMeans: "Simmering a liquid until some of it evaporates, concentrating the flavor and thickening the texture.",
    whyItMatters: "It's how a thin liquid becomes a rich sauce without adding flour or cream -- pure concentration.",
    sayItLikeThis: "" },
  { id: "dict-deglaze", term: "Deglaze", category: "Kitchen & Prep",
    whatItMeans: "Adding liquid, often wine, to a hot pan after searing meat, to loosen the browned bits stuck to the bottom.",
    whyItMatters: "Those browned bits are concentrated flavor -- deglazing is how that flavor becomes part of the sauce instead of getting scrubbed away.",
    sayItLikeThis: "" },
  { id: "dict-mise-en-place", term: "Mise en Place", category: "Kitchen & Prep",
    whatItMeans: "French for \u201ceverything in its place\u201d -- having all ingredients prepped, measured, and organized before cooking begins.",
    whyItMatters: "It's the difference between a kitchen that runs smoothly during a rush and one that doesn't.",
    sayItLikeThis: "" },
  { id: "dict-emulsify", term: "Emulsify / Emulsion", category: "Kitchen & Prep",
    whatItMeans: "Combining two liquids that don't naturally mix, like oil and vinegar, into a stable, creamy blend.",
    whyItMatters: "It's the basic technique behind mayo, aioli, and vinaigrettes -- and explains why some dressings separate and others don't.",
    sayItLikeThis: "" },
  { id: "dict-aburi", term: "Aburi", category: "Kitchen & Prep",
    whatItMeans: "A Japanese technique of lightly searing the surface of raw fish with a torch or hot metal, leaving the inside raw.",
    whyItMatters: "It's a flavor and texture choice, not a doneness change -- used on richer cuts to render a little fat and add a smoky edge.",
    sayItLikeThis: "That's lightly torched to render some of the fat and add a bit of smoke." },

  // Sushi & Japanese Terms
  { id: "dict-omakase", term: "Omakase", category: "Sushi & Japanese Terms",
    whatItMeans: "Japanese for \u201cI'll leave it up to you\u201d -- a chef-curated tasting where the diner doesn't order individual items.",
    whyItMatters: "It's a trust-based format -- the value is in the chef's judgment and the surprise, not a fixed menu to review in advance.",
    sayItLikeThis: "It's chef's choice tonight -- whatever's freshest, in the order the chef wants you to taste it." },
  { id: "dict-nigiri", term: "Nigiri", category: "Sushi & Japanese Terms",
    whatItMeans: "A hand-pressed mound of seasoned rice topped with a slice of fish or other ingredient.",
    whyItMatters: "Distinguishes it from sashimi (no rice) and maki (rolled) -- the three basic formats guests will ask about.",
    sayItLikeThis: "" },
  { id: "dict-sashimi", term: "Sashimi", category: "Sushi & Japanese Terms",
    whatItMeans: "Thinly sliced raw fish served on its own, with no rice.",
    whyItMatters: "Often confused with sushi generally -- sashimi refers specifically to the fish alone.",
    sayItLikeThis: "" },
  { id: "dict-maki", term: "Maki", category: "Sushi & Japanese Terms",
    whatItMeans: "Rice and fillings rolled in nori (seaweed) and sliced into pieces.",
    whyItMatters: "The general Japanese term for what most guests just call \u201ca roll.\u201d",
    sayItLikeThis: "" },
  { id: "dict-itamae", term: "Itamae", category: "Sushi & Japanese Terms",
    whatItMeans: "A trained sushi chef -- literally \u201cin front of the board\u201d -- a title earned through years of apprenticeship.",
    whyItMatters: "Worth knowing as a sign of respect -- it's not just interchangeable with \u201ccook.\u201d",
    sayItLikeThis: "" },
  { id: "dict-yubiki", term: "Yubiki", category: "Sushi & Japanese Terms",
    ...
    whyItMatters: "It's why some fish is served with the skin on, tender rather than tough.",
    sayItLikeThis: "" },
  { id: "dict-wasabi", term: "Wasabi (real vs. prepared)", category: "Sushi & Japanese Terms",
    whatItMeans: "True wasabi is a fresh-grated rhizome with a delicate, short-lived heat. Most \u201cwasabi\u201d served in the US, including the bright green paste, is actually horseradish, mustard, and food coloring.",
    whyItMatters: "Real wasabi loses its potency within minutes of grating, which is why it's grated to order -- worth knowing if a guest asks.",
    sayItLikeThis: "Just so you know, that's a wasabi-style prepared paste, not the fresh root." },
  { id: "dict-shoyu", term: "Shoyu", category: "Sushi & Japanese Terms",
    whatItMeans: "Japanese soy sauce, made from fermented soybeans and wheat.",
    whyItMatters: "It's relevant to allergy conversations, since it contains both soy and wheat/gluten, not just \u201csoy sauce\u201d generically.",
    sayItLikeThis: "" },

  // Service & Floor
  { id: "dict-86d", term: "86'd", category: "Service & Floor",
    whatItMeans: "An item that's sold out or no longer available for the rest of service.",
    whyItMatters: "Essential kitchen-to-floor communication -- said clearly and early so a server doesn't sell something that can't be delivered.",
    sayItLikeThis: "" },
  { id: "dict-in-the-weeds", term: "In the Weeds", category: "Service & Floor",
    whatItMeans: "Being overwhelmed and behind during a rush.",
    whyItMatters: "Recognizing it in yourself or a teammate early is what keeps a bad moment from becoming a bad table.",
    sayItLikeThis: "" },
  { id: "dict-fire", term: "Fire (a table/course)", category: "Service & Floor",
    whatItMeans: "Telling the kitchen to start cooking a specific course now, timed against what the table is currently eating.",
    whyItMatters: "Timing is the difference between a table that flows and one where the entr\u00e9e arrives while appetizer plates are still out.",
    sayItLikeThis: "" },
  { id: "dict-expo", term: "Expo", category: "Service & Floor",
    whatItMeans: "The expediter -- the person who checks every plate against the ticket before it leaves the kitchen and calls out when tables are ready to fire.",
    whyItMatters: "The communication hub between kitchen and floor -- not just a garnish-checker.",
    sayItLikeThis: "" },
  { id: "dict-turn", term: "Turn (a table)", category: "Service & Floor",
    whatItMeans: "The full cycle of a table being seated, served, and cleared for the next reservation.",
    whyItMatters: "A core metric for how a restaurant manages capacity on a busy night -- pacing service affects turn time directly.",
    sayItLikeThis: "" },
  { id: "dict-comp", term: "Comp", category: "Service & Floor",
    whatItMeans: "Short for \u201ccomplimentary\u201d -- removing a charge from a check, usually to address a service issue.",
    whyItMatters: "Knowing your restaurant's actual comp policy prevents both under-fixing a bad experience and over-giving without cause.",
    sayItLikeThis: "" },
  { id: "dict-split", term: "Split (a check/course)", category: "Service & Floor",
    whatItMeans: "Dividing a bill across multiple guests, or dividing a single dish across multiple plates for the table.",
    whyItMatters: "Worth confirming early in a meal, not after the check arrives -- avoids an awkward moment at the end.",
    sayItLikeThis: "Would you like that split three ways in the kitchen, or family-style down the middle?" },
  { id: "dict-cover", term: "Cover", category: "Service & Floor",
    whatItMeans: "One guest, for the purpose of counting how many people a restaurant served -- as in \u201cwe did 120 covers tonight.\u201d",
    whyItMatters: "The basic unit restaurants use to measure a night's volume -- distinct from \u201ca table,\u201d since one table might be four covers.",
    sayItLikeThis: "" }
];
