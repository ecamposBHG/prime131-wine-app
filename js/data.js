...
const DISHES = [
  ...
  { id: "d-burger", name: "Prime 131 Burger", section: "Entrées", description: "American cheese, veal bacon, brioche bun, special sauce, french fries", pairedWineIds: ["w12", "w15"], quizClue: "A grilled house-blend beef patty on a brioche bun with veal bacon, American cheese, and a special sauce built from pickles and dijon.", dropLine: "woodfire grilled burger with veal bacon and special sauce", ingredients: "special sauce- pickles, chili flakes, olive oil, ketchup, dijon mustard, mayo.  Garnish- french fries, ketchup. Veal bacon- same as app.", chefPrep: "burger build- grilled brioche bun, grilled veal bacon, special sauce, grilled house blend prime beed patty, bib lettuce, american cheese, tomato, olive oil.", allergensInRecipe: ["chili", "citrus", "dairy", "egg", "fish", "gluten", "vinegar"], allergensRemovable: ["citrus", "egg", "vinegar"] },
  ...
  { id: "d-chefs-nigiri", name: "Chef's Selection of Nigiri", section: "Sushi", description: "Chef's choice, 3/6/9/12 pieces", pairedWineIds: ["w10", "w20"], quizClue: "Five, seven, or ten pieces of the freshest hand-pressed fish of the day, served with fresh grated wasabi.", dropLine: "chefs choice of nigiri selection", ingredients: "seasoned sushi rice, fresh grated wasabi, seasonal garnishes", chefPrep: "chefs choice of 5,7 and 10 pcs of freshest daily nigiri selection served with, fres grated wasabi.", allergensInRecipe: ["fish", "shellfish", "vinegar"], allergensRemovable: ["shellfish"] },
