...
const DISHES = [
  ...
  { id: "d-basque-cheesecake", name: "Basque Cheesecake", section: "Desserts", description: "", pairedWineIds: [] },
  { id: "d-skillet-fudge", name: "Skillet Fudge", section: "Desserts", description: "", pairedWineIds: [] },
  { id: "d-sorbet-flight", name: "Sorbet Flight", section: "Desserts", description: "", pairedWineIds: [] },
  { id: "d-lemon-and-lime", name: "Lemon and Lime", section: "Desserts", description: "", pairedWineIds: [] },
  { id: "d-black-forest", name: "Black Forest", section: "Desserts", description: "", pairedWineIds: [] },
...
// Staff dictionary: every term here is pulled from real ingredient/prep/winemaking text
// already used across the menu, not a generic hospitality glossary.
const DICTIONARY = [
  // Japanese & Sushi Terms
  { id: "dict-ponzu", term: "Ponzu", category: "Japanese & Sushi Terms",
    whatItMeans: "A citrus-based soy sauce, built on soy, rice vinegar, and citrus juice (traditionally yuzu).",
    whyItMatters: "It's the base of the house ponzu used across Oysters, Yellowtail Carpaccio, and the whole roasted Lobster's garlic ponzu butter -- the acid-forward backbone of most of the raw bar.",
    sayItLikeThis: "" },
  { id: "dict-mirin", term: "Mirin", category: "Japanese & Sushi Terms",
    whatItMeans: "A sweet Japanese rice wine, lower in alcohol than sake, used for a gentle sweetness and glaze.",
    whyItMatters: "It's in the house ponzu, the Unagi glaze, the Ikura marinade, and the Tamagoyaki mix -- one of the most repeated ingredients in the sushi program.",
    sayItLikeThis: "" },
  { id: "dict-konbu", term: "Konbu (Kombu)", category: "Japanese & Sushi Terms",
    whatItMeans: "Dried kelp, used to make dashi and to build savory depth in sauces.",
    whyItMatters: "It's in the house ponzu, shiro dashi, and the tamagoyaki dashi -- the umami base underneath a lot of what tastes \u201cclean but savory\u201d on the menu.",
    sayItLikeThis: "" },
  { id: "dict-bonito", term: "Bonito Flakes", category: "Japanese & Sushi Terms",
    whatItMeans: "Shaved, dried, smoked skipjack tuna, used to build dashi and savory sauces.",
    whyItMatters: "Appears in the house ponzu and shiro dashi -- if a guest asks about fish allergens in a \u201cvegetarian-sounding\u201d sauce, this is often why it isn't actually vegetarian.",
    sayItLikeThis: "" },
  { id: "dict-dashi", term: "Dashi", category: "Japanese & Sushi Terms",
    whatItMeans: "A basic Japanese stock, usually built from konbu and bonito flakes.",
    whyItMatters: "It's the base of the Tamagoyaki mix -- the reason the rolled omelette tastes savory-sweet rather than like a plain Western omelette.",
    sayItLikeThis: "" },
  { id: "dict-shiro-dashi", term: "Shiro Dashi", category: "Japanese & Sushi Terms",
    whatItMeans: "A concentrated, pale soy-based seasoning sauce built on bonito, konbu, soy, and mirin.",
    whyItMatters: "It's the base of the charred fresno vinaigrette on the Oysters -- where a lot of that dish's savory depth actually comes from.",
    sayItLikeThis: "" },
  { id: "dict-togarashi", term: "Togarashi", category: "Japanese & Sushi Terms",
    whatItMeans: "A Japanese seven-spice chili blend (shichimi togarashi), or in some builds a simpler ichimi (single-pepper) version.",
    whyItMatters: "It shows up in the Yellowtail Carpaccio's ponzu, the Lobster's garlic ponzu butter, and the Crunchy Spicy Tuna Roll's spicy mayo -- the house's go-to chili-heat seasoning.",
    sayItLikeThis: "" },
  { id: "dict-furikake", term: "Furikake", category: "Japanese & Sushi Terms",
    whatItMeans: "A dry Japanese seasoning blend, usually sesame seeds, seaweed flakes, and salt.",
    whyItMatters: "It's what seasons the Fried Shishitos after they come off the heat -- the finishing touch, not part of the cook.",
    sayItLikeThis: "" },
  { id: "dict-miso", term: "Miso", category: "Japanese & Sushi Terms",
    whatItMeans: "Fermented soybean paste; white miso specifically is milder and sweeter than red or aged miso varieties.",
    whyItMatters: "It's the base of the Miso Cod marinade and the Miso Salmon Roll's teriyaki sauce -- and a real soy allergen to flag, since it's easy to miss under the name \u201cmiso\u201d rather than \u201csoy.\u201d",
    sayItLikeThis: "" },
  { id: "dict-kanpyo", term: "Kanpyo", category: "Japanese & Sushi Terms",
    whatItMeans: "Dried, sweetened gourd shavings, a classic sushi roll filling.",
    whyItMatters: "It's the sweet component inside the Miso Salmon Roll, alongside tempura asparagus and avocado.",
    sayItLikeThis: "" },
  { id: "dict-shiso", term: "Shiso", category: "Japanese & Sushi Terms",
    whatItMeans: "A Japanese herb in the mint family, with a flavor somewhere between basil, mint, and anise.",
    whyItMatters: "It's in the Lobster's garlic ponzu butter and the Prime 131 Roll -- described on our own prep sheet simply as \u201cJapanese mint\u201d for a quick guest explanation.",
    sayItLikeThis: "That's shiso -- a Japanese herb, a bit like a cross between basil and mint." },
  { id: "dict-kaiware", term: "Kaiware", category: "Japanese & Sushi Terms",
    whatItMeans: "Daikon radish sprouts, with a sharp, peppery bite similar to watercress.",
    whyItMatters: "It's rolled inside the Crunchy Spicy Tuna Roll for crunch and a little heat contrast against the spicy mayo.",
    sayItLikeThis: "" },
  { id: "dict-yuzu-kosho", term: "Yuzu Kosho", category: "Japanese & Sushi Terms",
    whatItMeans: "A fermented paste of yuzu citrus zest, chili, and salt.",
    whyItMatters: "It's blended into the aioli on the Prime 131 Roll -- the source of that roll's citrus-heat kick, distinct from the plain yuzu juice used elsewhere.",
    sayItLikeThis: "" },
  { id: "dict-wasabi-real", term: "Wasabi (real vs. prepared)", category: "Japanese & Sushi Terms",
    whatItMeans: "True wasabi is a fresh-grated rhizome with delicate, short-lived heat. Most \u201cwasabi\u201d served in the US, including bright green paste, is actually horseradish, mustard, and food coloring.",
    whyItMatters: "Our own prep notes specifically call for \u201cfresh grated wasabi\u201d on nigiri -- worth knowing the difference if a guest asks what they're actually getting.",
    sayItLikeThis: "That's fresh-grated wasabi root, not the prepared paste most people are used to." },
  { id: "dict-kizami-wasabi", term: "Kizami Wasabi", category: "Japanese & Sushi Terms",
    whatItMeans: "A chopped wasabi condiment blended with horseradish, soy sauce, sugar, and oil -- milder and saucier than fresh wasabi.",
    whyItMatters: "It's rolled inside the Yellowtail Serrano Roll, distinct from the fresh wasabi served alongside nigiri.",
    sayItLikeThis: "" },
  { id: "dict-eel-sauce", term: "Eel Sauce (Unagi Tare)", category: "Japanese & Sushi Terms",
    whatItMeans: "A sweet, thick glaze of soy sauce, sugar, and mirin, thickened with starch -- despite the name, it doesn't necessarily contain eel itself.",
    whyItMatters: "It's used both to glaze the Unagi itself and as a garnish sauce on the Crunchy Spicy Tuna Roll and Dragon Roll.",
    sayItLikeThis: "" },
  { id: "dict-omakase", term: "Omakase", category: "Japanese & Sushi Terms",
    whatItMeans: "Japanese for \u201cI'll leave it up to you\u201d -- a chef-curated tasting where the diner doesn't order individual items.",
    whyItMatters: "It's literally our own Omakase Platter's format: 14 pieces sashimi, 14 pieces nigiri, 3 specialty rolls of the guest's choosing.",
    sayItLikeThis: "It's chef's choice tonight -- whatever's freshest, in the order the chef wants you to taste it." },
  { id: "dict-nigiri", term: "Nigiri", category: "Japanese & Sushi Terms",
    whatItMeans: "A hand-pressed mound of seasoned rice topped with a slice of fish or other ingredient.",
    whyItMatters: "It's how Ikura, Tamagoyaki, Unagi, Maguro, and most of the raw-cut fish are served when not ordered as sashimi.",
    sayItLikeThis: "" },
  { id: "dict-sashimi", term: "Sashimi", category: "Japanese & Sushi Terms",
    whatItMeans: "Thinly sliced raw fish served on its own, with no rice.",
    whyItMatters: "It's the format for the Premium Sashimi Platter and the raw-cut fish when ordered without rice.",
    sayItLikeThis: "" },
  { id: "dict-maki", term: "Maki", category: "Japanese & Sushi Terms",
    whatItMeans: "Rice and fillings rolled in nori (seaweed) and sliced into pieces.",
    whyItMatters: "The general term for the Dragon Roll, California Roll, Negi Toro Roll, and the rest of the roll program.",
    sayItLikeThis: "" },
  { id: "dict-yubiki", term: "Yubiki", category: "Japanese & Sushi Terms",
    whatItMeans: "A technique of briefly scalding a fish's skin with hot water then shocking it in ice, softening the skin without cooking the flesh.",
    whyItMatters: "It's specifically how the Madai is prepped before slicing -- why it's served with tender skin rather than tough skin.",
    sayItLikeThis: "" },

  // Specialty Ingredients & Sauces
  { id: "dict-tahini", term: "Tahini", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A paste made from ground sesame seeds.",
    whyItMatters: "It's the base of the Babaganoush served with the Grilled Naan -- and a sesame allergen worth flagging even when a guest doesn't see visible seeds.",
    sayItLikeThis: "" },
  { id: "dict-zaatar", term: "Za'atar", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A Middle Eastern spice blend of dried thyme, sumac, and toasted sesame seeds.",
    whyItMatters: "It's garnished on the Labneh dip served with the Grilled Naan.",
    sayItLikeThis: "" },
  { id: "dict-sumac", term: "Sumac", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A tart, deep-red ground spice made from dried sumac berries, with a lemony flavor but no citrus in it.",
    whyItMatters: "It's garnished on the Babaganoush -- worth knowing it's a spice, not a citrus product, if a guest asks.",
    sayItLikeThis: "" },
  { id: "dict-dukkah", term: "Dukkah", category: "Specialty Ingredients & Sauces",
    whatItMeans: "An Egyptian spice and nut blend, in our case pistachios, toasted sesame seeds, cumin, and coriander.",
    whyItMatters: "It's on the Fire-Roasted Beets -- and a real tree nut and sesame allergen, not just a garnish crunch.",
    sayItLikeThis: "" },
  { id: "dict-labneh", term: "Labneh", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A strained, tangy yogurt cheese, thicker than Greek yogurt.",
    whyItMatters: "It's one of the three dips served with Grilled Naan, and also spread under the Fire-Roasted Beets.",
    sayItLikeThis: "" },
  { id: "dict-baba-ganoush", term: "Baba Ganoush", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A smoky eggplant dip -- eggplant charred over an open flame, then blended with tahini, lemon, and garlic.",
    whyItMatters: "One of the three dips served with Grilled Naan; the smokiness comes specifically from charring the eggplant whole before blending.",
    sayItLikeThis: "" },
  { id: "dict-aleppo", term: "Aleppo Pepper", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A moderately spicy, fruity dried Syrian chili, milder than cayenne.",
    whyItMatters: "It's in the Clam Chowder base -- the source of that soup's gentle background heat.",
    sayItLikeThis: "" },
  { id: "dict-espelette", term: "Espelette Pepper", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A mild, fruity chili pepper from the Basque region of France.",
    whyItMatters: "It's in the Marinated Chicken's marinade -- part of why that dish reads as warm and peppery rather than sharply hot.",
    sayItLikeThis: "" },
  { id: "dict-saba-vinegar", term: "Saba Vinegar", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A vinegar made from reduced grape must and red wine vinegar -- sweeter and more syrupy than standard vinegar.",
    whyItMatters: "It's on the Wagyu Skirt Steak and in the house Steak Sauce -- adds acidity with sweetness rather than sharpness.",
    sayItLikeThis: "" },
  { id: "dict-fourme", term: "Fourme d'Ambert", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A French blue cheese, milder and creamier than a typical sharp blue.",
    whyItMatters: "It's the specific blue cheese garnish on the Wagyu Skirt Steak, not a generic blue cheese crumble.",
    sayItLikeThis: "" },
  { id: "dict-agar-agar", term: "Agar Agar", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A plant-based, algae-derived gelling agent, used as a vegetarian substitute for gelatin.",
    whyItMatters: "It's used in the Chicken Fried Lobster's preserved lemon gel and the coconut lemongrass espuma on the Miso Cod.",
    sayItLikeThis: "" },
  { id: "dict-xanthan", term: "Xanthan Gum", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A plant-fermentation-derived thickener, used in small amounts to add body without flavor.",
    whyItMatters: "It's in the gluten-free breading mix for the Chicken Fried Lobster -- part of what gives that breading structure without wheat flour.",
    sayItLikeThis: "" },
  { id: "dict-orgeat", term: "Orgeat", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A sweet, non-alcoholic almond syrup, often with a hint of orange flower water.",
    whyItMatters: "It's a core ingredient in the Mai Tai -- the source of its almond note alongside the rum.",
    sayItLikeThis: "" },
  { id: "dict-curacao", term: "Cura\u00e7ao", category: "Specialty Ingredients & Sauces",
    whatItMeans: "An orange-flavored liqueur, originally made from the dried peel of Laraha citrus.",
    whyItMatters: "It's the orange liqueur in the Mai Tai -- different from the Cointreau used in other house and classic cocktails.",
    sayItLikeThis: "" },
  { id: "dict-amaro", term: "Amaro", category: "Specialty Ingredients & Sauces",
    whatItMeans: "An Italian bitter herbal liqueur; \u201camaro\u201d is the category, with many brands and styles underneath it.",
    whyItMatters: "Amaro Nonino specifically is one-quarter of the Paper Plane -- a bitter, herbal counterweight to the bourbon and Aperol.",
    sayItLikeThis: "" },
  { id: "dict-absinthe", term: "Absinthe", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A high-proof, anise-forward spirit traditionally flavored with wormwood.",
    whyItMatters: "It's used as a rinse in the Sazerac -- just a coating of the glass, not an actual pour, so the anise note stays in the background.",
    sayItLikeThis: "" },
  { id: "dict-benedictine", term: "B\u00e9n\u00e9dictine", category: "Specialty Ingredients & Sauces",
    whatItMeans: "A French herbal liqueur, originally developed by Benedictine monks, with honeyed, spiced notes.",
    whyItMatters: "It's the small but essential fourth ingredient in the Vieux Carr\u00e9, alongside rye, cognac, and sweet vermouth.",
    sayItLikeThis: "" },

  // Kitchen & Prep Techniques
  { id: "dict-confit", term: "Confit", category: "Kitchen & Prep Techniques",
    whatItMeans: "Cooking something slowly and gently, submerged in fat, at low temperature.",
    whyItMatters: "Garlic confit is on nearly every steak on the menu -- it's why the garlic served alongside is soft and mellow, not sharp and raw.",
    sayItLikeThis: "" },
  { id: "dict-braise", term: "Braise", category: "Kitchen & Prep Techniques",
    whatItMeans: "Searing a tough cut of meat first, then slow-cooking it in liquid at low heat for a long time until tender.",
    whyItMatters: "It's exactly how the Short Rib is cooked -- seared, then braised roughly 3 hours until it falls apart.",
    sayItLikeThis: "" },
  { id: "dict-blanch", term: "Blanch", category: "Kitchen & Prep Techniques",
    whatItMeans: "Briefly boiling a vegetable, then immediately shocking it in ice water to stop the cooking.",
    whyItMatters: "It's how the Broccolini and the Mac & Cheese's pasta shells are prepped before the final cook, and how the Miso Cod's bok choy is prepped before service.",
    sayItLikeThis: "" },
  { id: "dict-sear", term: "Sear", category: "Kitchen & Prep Techniques",
    whatItMeans: "Cooking the surface of food at high heat to create a browned crust, without necessarily cooking it through.",
    whyItMatters: "The Prime 131 Roll's foie gras is seared before rolling, and the Short Rib is seared hard before it ever hits the braising liquid.",
    sayItLikeThis: "" },
  { id: "dict-emulsify", term: "Emulsify / Emulsion", category: "Kitchen & Prep Techniques",
    whatItMeans: "Combining two ingredients that don't naturally mix, like fat and liquid, into a stable, blended texture.",
    whyItMatters: "It's exactly how the brown butter aioli for the Chicken Fried Lobster comes together -- blended until the butter fully emulsifies into the base.",
    sayItLikeThis: "" },
  { id: "dict-espuma", term: "Espuma", category: "Kitchen & Prep Techniques",
    whatItMeans: "Spanish for \u201cfoam\u201d -- a light, airy foam made from a flavored liquid, usually set with a stabilizer like agar agar.",
    whyItMatters: "It's the coconut lemongrass espuma served with the Miso Cod -- a foam, not a sauce, meant to be light on the plate.",
    sayItLikeThis: "" },
  { id: "dict-torchon", term: "Torchon", category: "Kitchen & Prep Techniques",
    whatItMeans: "Rolling a soft ingredient into a tight cylinder shape, usually in plastic wrap, to set its shape for clean slicing.",
    whyItMatters: "It's how the Truffle Butter is shaped and stored before service.",
    sayItLikeThis: "" },

  // Beef & Wagyu Grading
  { id: "dict-marbling", term: "Marbling", category: "Beef & Wagyu Grading",
    whatItMeans: "The flecks of fat running through a piece of meat, as opposed to fat only around the edges.",
    whyItMatters: "It's directly why the higher-graded steaks taste richer and more tender -- more marbling means more fat melting through the meat as it cooks.",
    sayItLikeThis: "" },
  { id: "dict-bms", term: "BMS (Beef Marbling Score)", category: "Beef & Wagyu Grading",
    whatItMeans: "A numeric scale used to grade how much marbling is in a cut of beef -- higher numbers mean more marbling.",
    whyItMatters: "SRF Gold Label (used on our tenderloin, NY strip, and ribeye) scores a BMS of 9 or higher -- the highest tier we carry.",
    sayItLikeThis: "" },
  { id: "dict-a5-wagyu", term: "A5 Wagyu", category: "Beef & Wagyu Grading",
    whatItMeans: "The top Japanese beef grade -- \u201cA\u201d for yield grade, \u201c5\u201d for the highest quality score, covering marbling, color, and texture.",
    whyItMatters: "The rendered fat brushed on every steak on the menu is A5 wagyu fat, and the Kagawa Olive Beef itself is A5-graded.",
    sayItLikeThis: "" },
  { id: "dict-srf", term: "Snake River Farms Gold Label", category: "Beef & Wagyu Grading",
    whatItMeans: "A cross between purebred Japanese Wagyu and high-quality American cattle, with Gold Label being their highest marbling tier (BMS 9+).",
    whyItMatters: "It's specifically what the 8oz Tenderloin, 12oz NY Strip, and Ribeye are cut from.",
    sayItLikeThis: "" },
  { id: "dict-sher-wagyu", term: "Sher Wagyu / Fullblood", category: "Beef & Wagyu Grading",
    whatItMeans: "A Fullblood (100% genetic) Australian Wagyu herd, traceable to Japanese bloodlines, DNA-registered with full pedigrees.",
    whyItMatters: "It's the source of the 14oz Australian NY Strip and the 32oz Tomahawk -- Australian Wagyu, not American, and a different program from Snake River Farms.",
    sayItLikeThis: "" },
  { id: "dict-olive-wagyu", term: "Olive Wagyu (Sanuki)", category: "Beef & Wagyu Grading",
    whatItMeans: "Wagyu cattle from Shodoshima Island, Japan, fed a diet that includes dehydrated olive pulp -- a byproduct of the island's olive oil production.",
    whyItMatters: "It's specifically what the Kagawa Olive Beef Tenderloin is -- the olive feed is what gives it a slightly nutty character in the fat.",
    sayItLikeThis: "" },
  { id: "dict-usda-prime", term: "USDA Prime", category: "Beef & Wagyu Grading",
    whatItMeans: "The U.S. Department of Agriculture's highest quality grade for beef, based on tenderness, juiciness, and marbling.",
    whyItMatters: "Less than 2% of all beef produced in the US earns this grade -- it's the floor our Classics-tier steaks start at, not the ceiling.",
    sayItLikeThis: "" },
  { id: "dict-halal", term: "Halal", category: "Beef & Wagyu Grading",
    whatItMeans: "Meat processed according to Islamic dietary law.",
    whyItMatters: "Our Sher Wagyu (Australian) program is Halal accredited -- worth knowing if a guest asks directly.",
    sayItLikeThis: "" },

  // Wine Production Terms
  { id: "dict-charmat", term: "Charmat Method", category: "Wine Production Terms",
    whatItMeans: "A sparkling wine production method where the second fermentation happens in a large pressurized tank, not in the individual bottle.",
    whyItMatters: "It's how the Ruffino Prosecco is made -- generally a faster, fruitier style of sparkling wine than the traditional method.",
    sayItLikeThis: "" },
  { id: "dict-traditional-method", term: "Traditional Method", category: "Wine Production Terms",
    whatItMeans: "A sparkling wine production method where the second fermentation happens inside each individual bottle -- the Champagne method.",
    whyItMatters: "It's how both the Telmont R\u00e9serve Brut and Nicolas Feuillatte Ros\u00e9 are made -- the reason they carry finer bubbles and toastier, brioche-like character than the Prosecco.",
    sayItLikeThis: "" },
  { id: "dict-malolactic", term: "Malolactic Fermentation (\u201cmalo\u201d)", category: "Wine Production Terms",
    whatItMeans: "A secondary fermentation that converts sharp malic acid (green apple) into softer lactic acid (milk-like), done by bacteria rather than yeast.",
    whyItMatters: "It's specifically why the Cambria and Stag's Leap Chardonnays taste creamy and round instead of crisp and steely -- a winemaking choice, not a grape trait.",
    sayItLikeThis: "That creamy texture isn't oak -- it's a process called malolactic fermentation." },
  { id: "dict-dry-farmed", term: "Dry-Farmed", category: "Wine Production Terms",
    whatItMeans: "Growing grapevines with no irrigation, relying entirely on natural rainfall.",
    whyItMatters: "The Benton-Lane Pinot Noir is dry-farmed -- the vine stress from no irrigation pushes roots deeper and concentrates flavor in a naturally lighter-bodied wine.",
    sayItLikeThis: "" },
  { id: "dict-native-yeast", term: "Native Yeast Fermentation", category: "Wine Production Terms",
    whatItMeans: "Fermenting wine using the wild yeast naturally present on the grapes and in the winery, instead of adding a commercial yeast strain.",
    whyItMatters: "It's part of how the Flowers Pinot Noir is made -- a minimal-intervention approach meant to let the specific vineyard site show through.",
    sayItLikeThis: "" },
  { id: "dict-grand-vin", term: "Grand Vin", category: "Wine Production Terms",
    whatItMeans: "A French term for an estate's flagship, top-tier wine -- as opposed to its second wine.",
    whyItMatters: "Madame de Beaucaillou is the second wine of Ch\u00e2teau Ducru-Beaucaillou, aged in the same cellar as their grand vin.",
    sayItLikeThis: "" },
  { id: "dict-declassified", term: "Declassified", category: "Wine Production Terms",
    whatItMeans: "Fruit or finished wine that doesn't make the cut for an estate's top bottling, and is instead used in a second, more accessible wine.",
    whyItMatters: "Madame de Beaucaillou is blended partly from younger vines and lots declassified from Ch\u00e2teau Ducru-Beaucaillou's flagship wine.",
    sayItLikeThis: "" },
  { id: "dict-skin-contact", term: "Skin Contact", category: "Wine Production Terms",
    whatItMeans: "How long grape skins stay in contact with the juice before pressing -- more time means more color and tannin extracted.",
    whyItMatters: "It's the whole story behind ros\u00e9 style on our list: Miraval gets minimal skin contact for a pale, dry style, while the Sancerre Ros\u00e9 gets just a few hours for a similar effect from Pinot Noir grapes.",
    sayItLikeThis: "" },
  { id: "dict-rice-polish", term: "Rice Polish Rate", category: "Wine Production Terms",
    whatItMeans: "How much of the outer rice grain is milled away before sake brewing -- a lower percentage means more polishing, which generally means a more fragrant, refined sake.",
    whyItMatters: "The Yoshi No Gawa is milled to 60% of its original grain size -- that's the number behind its \u201cJunmai Ginjo\u201d classification.",
    sayItLikeThis: "" },

  // Bar Technique Terms
  { id: "dict-rinse", term: "Rinse (a glass)", category: "Bar Technique Terms",
    whatItMeans: "Coating the inside of a glass with a small amount of a strong spirit, then discarding the excess before building the drink in it.",
    whyItMatters: "It's exactly how the absinthe goes into a Sazerac -- just a coating for aroma, not an actual pour into the drink.",
    sayItLikeThis: "" },
  { id: "dict-overproof", term: "Overproof", category: "Bar Technique Terms",
    whatItMeans: "A spirit bottled at a significantly higher alcohol percentage than standard (typically 57.5%+ ABV, or 115+ proof).",
    whyItMatters: "It's half of the rum base in the Mai Tai -- paired with an aged rum for depth without making the whole drink taste thin.",
    sayItLikeThis: "" },
  { id: "dict-barspoon", term: "Barspoon", category: "Bar Technique Terms",
    whatItMeans: "A long-handled spoon used for stirring cocktails and measuring very small amounts, roughly 1/8 oz per spoonful.",
    whyItMatters: "The Oaxacan Old Fashioned calls for exactly one barspoon of agave syrup -- small enough that a regular jigger measurement isn't practical.",
    sayItLikeThis: "" },
  { id: "dict-dry-shake", term: "Dry Shake", category: "Bar Technique Terms",
    whatItMeans: "Shaking a cocktail without ice first, then shaking it again with ice -- used specifically for egg white drinks.",
    whyItMatters: "It's how the Whiskey Sour is built when a guest wants the egg white version -- the dry shake is what creates the thick foam on top.",
    sayItLikeThis: "" },
  { id: "dict-double-strain", term: "Double Strain", category: "Bar Technique Terms",
    whatItMeans: "Straining a shaken cocktail through both the shaker's built-in strainer and a fine mesh strainer, to catch small ice shards and pulp.",
    whyItMatters: "The Gilded Goose is double strained -- worth the extra step since it has no juice or garnish to hide small ice chips floating in a martini glass.",
    sayItLikeThis: "" },
  { id: "dict-float-bar", term: "Float", category: "Bar Technique Terms",
    whatItMeans: "Pouring one ingredient gently over the back of a spoon so it sits on top of a drink instead of mixing in.",
    whyItMatters: "It's how the cream sits on top of a White Russian, and how sparkling wine tops the Golden 'B' without going flat from over-mixing.",
    sayItLikeThis: "" },
  { id: "dict-express-bar", term: "Express (a peel)", category: "Bar Technique Terms",
    whatItMeans: "Bending a piece of citrus peel over a drink to release its aromatic oils onto the surface.",
    whyItMatters: "It's why the Sazerac's lemon peel is expressed and discarded, not left floating in the glass -- it's for aroma, not garnish.",
    sayItLikeThis: "" },
  { id: "dict-muddle-bar", term: "Muddle", category: "Bar Technique Terms",
    whatItMeans: "Gently pressing fruit or herbs in the bottom of a glass to release their oils and juices before building a drink.",
    whyItMatters: "It's the technique behind the Mint Julep and Mojito -- a light press, not a mash, since over-muddling mint releases bitter chlorophyll.",
    sayItLikeThis: "" }
];
